...
public class RecipeBootstrap implements ApplicationListener<ContextRefreshedEvent> {
    ...
    private List<Recipe> getRecipes() {
        ...
        Recipe guacRecipe = GeneralBuilder.Builder.build(Recipe.class)
                .with(s -> s.setDescription("Perfect Guacamole"))
                .with(s -> s.setPrepTime(10))
                .with(s -> s.setCookTime(0))
                .with(s->s.setDifficulty(Difficulty.EASY))
                .with(s->s.setDirections("1 Cut avocado, remove flesh: Cut the avocados in half. Remove seed. Score the inside of the avocado with a blunt knife and scoop out the flesh with a spoon" +
                        "\n" +
...
//                "Read more: http://www.simplyrecipes.com/recipes/perfect_guacamole/#ixzz4jvpiV9Sd");
        ...
        Ingredient avocado =GeneralBuilder.Builder.build(Ingredient.class)
                .with(s -> s.setDescription("ripe avocados"))
                .with(s -> s.setAmount(new BigDecimal(2)))
                .with(s -> s.setRecipe(guacRecipe))
                .with(s -> s.setUom(eachUom))
                .get();
        
        

        guacRecipe.addIngredient(avocado);
